...
$mysqlPwd = [Environment]::GetEnvironmentVariable("ACCOUNT_TRADE_MYSQL_PASSWORD", "User")
if (-not $env:ACCOUNT_TRADE_MYSQL_PASSWORD -and $mysqlPwd) {
    $env:ACCOUNT_TRADE_MYSQL_PASSWORD = $mysqlPwd
}
