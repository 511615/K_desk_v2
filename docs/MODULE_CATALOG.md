...
| --- | --- | --- | --- |
| Account | Search, source selection, legacy detail page | FastAPI composition + LegacyBridge | `ACC` |
...
| Automation | Copy origins, follower profit, EA comment groups | governed legacy services | `AUT` |
